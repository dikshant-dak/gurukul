                ...
                <div class="absolute top-0 left-0 w-full h-[260px] md:h-[649px] text-white text-xl font-bold">
                    <div className="flex w-full h-[80px] items-center justify-around">
                        ...
                        <ul className="flex text-sm font-normal">
                            <li className="mx-[10px] cursor-pointer hover:opacity-90 hover:text-black ">Home</li>
                            <li className="mx-[10px] cursor-pointer hover:opacity-90 hover:text-black ">About</li>
                            <li className="mx-[10px] cursor-pointer hover:opacity-90 hover:text-black "><Link to ="/Courses">Courses</Link></li>
                            <li className="mx-[10px] cursor-pointer hover:opacity-90 hover:text-black ">Contact Us</li>
                        </ul>
